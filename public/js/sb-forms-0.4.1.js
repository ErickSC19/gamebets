...
var t=function(t,e,n,i){
    ...
    const e=(t,e=document.body)=>{
        ...
        class s{
            ...
            _handleInputAction(){
                let t=!0;
                if(this.validations.forEach((e=>{t=t&&r(this.input,e)
                })),
                a(this.input)){
                    ...
                    else{if(i.forEach((t=>t.dataset.sbCanSubmit="no")),
                    this.isPure)return this.onChange(),void(this.isPure=!1);
                ...
                this.input.classList.add("is-invalid")}this.onChange()
            }
            reset(){if(this.isPure=!0,a(this.input)){
    ...
    const a=t=>!!["checkbox","radio"].find((e=>e===t.type)),r=(t,i)=>{let s,r,c=!0;
        ...
        switch(i){case"required":a(t)?c=e("input",r).reduce(((t,e)=>t||e.checked),!1):t.value||(c=!1);break;
        case"email":c=o(t.value);break;case"length":c=d(t.value);
        break;
...
const l=(r,o)=>{
    ...
    m=n("#submitButton",r),f=n("#submitSuccessMessage",r),v=n("#submitErrorMessage",r),b=r.dataset.sbFormApiToken;
    "API_TOKEN"===b&&(d=!1,console.log(h,p));const E=o||e("input, textarea, select",r);
    E.forEach((t=>{const e=t.dataset.sbValidations;e?(t.dataset.sbCanSubmit="no",c.push(new s(t,(t=>{const e=t.split(",").map((t=>t.trim()));
    return e.forEach((t=>{if(!(t in i))throw new Error(`UNRECOGNIZED_VALIDATION_KEY: ${t}`)})),e})(e),l))):t.dataset.sbCanSubmit="yes"
}));
const y=e=>{
    return n=void 0,i=void 0,a=function*(){e.preventDefault(),m.classList.add("d-none");
    try{
        console.log(u(E)),d?yield(n={token:b,submissionObject:u(E)},t(void 0,void 0,void 0,(function*(){
            ...
            console.error(t),v.classList.remove("d-none")}var n},new((s=void 0)||(s=Promise))((function(t,e){function r(t){
                try{
                    d(a.next(t))
                }catch(t){
                    e(t)
                    ...
                    try{
                        ...
                        var n;e.done?t(e.value):(n=e.value,n instanceof s?n:new s((function(t){t(n)}))).then(r,o)}d((a=a.apply(n,i||[])).next())}));
                        var n,i,s,a},L=t=>y(t);
                        m.addEventListener("click",L);
                        const w=()=>{E.reduce(((t,n)=>{if(a(n)){const i=n.parentElement.parentElement,s=e("input",i);
                    ...
                    return c.forEach((t=>t.initValidation())),w(),{tearDown:()=>{
                        m.removeEventListener("click",L),f.classList.add("d-none"),v.classList.add("d-none"),m.classList.remove("d-none"),m.classList.add("disabled"),E.forEach((t=>{t.removeAttribute("disabled")})),c.forEach((t=>t.tearDown()))
                }
            }
        },u=t=>{
